...
<style scoped>
.events { display: grid; grid-template-rows: auto auto minmax(0,1fr); height: 100%; border-radius: 4px; }.panel-title { justify-content: space-between; }.panel-title b { color: var(--cyan); font-size: 9px; }.filters { display: flex; align-items: center; gap: 10px; padding: 8px; border-bottom: 1px solid var(--line); }.filters :deep(.n-select) { width: 105px; }.filters span { color: var(--muted); font-size: 9px; }

...
<style scoped>
.dock { display: grid; grid-template-columns: minmax(360px, .72fr) 1.28fr; height: 100%; border-radius: 4px; }.cli { display: grid; grid-template-rows: auto minmax(0,1fr) auto; border-right: 1px solid var(--line); }.prompt { display: grid; grid-template-columns: 45px 1fr; gap: 6px; padding: 10px; }.prompt>span { padding-top: 8px; color: var(--cyan); font-weight: 700; }.prompt :deep(textarea) { font-family: "SFMono-Regular", Consolas, monospace; }.cli-foot { display: flex; justify-content: space-between; align-items: center; padding: 6px 10px; border-top: 1px solid var(--line); }.cli-foot span { color: var(--muted); font-size: 8px; letter-spacing: .1em; }.cli-foot .ready { color: var(--green); }
